...
forked from  [Built Portfolio With GitHub ](https://github.com/said7388/github-portfolio)

---

visit the portfolio at [sdelahaies.fr](https://sdelahaies.fr)
...
### Then, Customize data in the `utils/data` [folder](https://github.com/sdelahaies/developer-portfolio/tree/main/utils/data).
