...
function ContactForm() {
  ...
  return (
    <div>
      <p className="font-medium mb-5 text-orange-600 text-xl uppercase">Get in touch</p>
        ...
        <div className="mt-6 flex flex-col gap-4">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-1 hover:gap-3 rounded-full bg-gradient-to-r from-orange-600 to-stone-600 px-5 md:px-12 py-2.5 md:py-3 text-center text-xs md:text-sm font-medium uppercase tracking-wider text-white no-underline transition-all duration-200 ease-out hover:text-white hover:no-underline md:font-semibold"
              role="button"
